...
*/
	...
	i2c_tx_buffer[0] = APDS9960_GCONF4; //write gesture interrupt enable
	i2c_tx_buffer[1] = val2;
	I2C_write();
	...
	i2c_tx_buffer[0] = APDS9960_GCONF1; // enable power, wait, proximity and gesture bit in enable register
	i2c_tx_buffer[1] = 0x00;
	I2C_write();
